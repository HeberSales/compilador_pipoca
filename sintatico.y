...
ATRIBUTO 	: TIPO TK_ID
			{	
				...
				addVarFunc($2.label, $1.tipo, temp);

				$$.varAtributo = temp;
				$$.traducao = $1.tipo + " " + temp;
				atributos_fun += $$.traducao + "; //atributo '" + $2.label + "'\n";
			}
			;
...
DECLARA_FUNCAO 	: TK_FUNC TIPO TK_ID '(' ATRIBUTOS ')' BLOCO
				{
					...
					if(encontrei) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Função (" + $3.label + ") Já declarada" + "\n";


					if (!$7.temRetorno && ($2.tipo != "void")){
						error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Retorno da função (" + $3.label + ") não expecificado.\n";
					}

					else if($7.temRetorno && $2.tipo == "void"){
						error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A função (" + $2.tipo + " " + $3.label + ") não deve ter retorno\n";
					}
						...
						error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A função (" + $2.tipo + " " + $3.label + ") Não pode retornar um " + retorno.tipoVariavel + ".\n";
					}
				}
				;
...
RETORNO 	: TK_RETURN E ';'
			...
			TK_RETURN TK_ID ';'
			{
				...
				if (!encontrei) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Variável (" + $2.label + ") Não declarada.\n";
...
TERNARIO 	: E '?' COMANDO ':' COMANDO
			{
				if($1.tipo != "bool") error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m O condicinal do loop deve ser um boolean\n";
...
COMANDOS	: COMANDO COMANDOS
			...
			{				
				if($2.tipo != "bool") error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m O condicinal do loop deve ser um boolean\n";
			...
			{
				if($2.tipo != "bool" || $5.tipo != "bool") error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m O condicinal do loop deve ser um boolean\n";
			...
			{
				if($4.tipo != "bool") error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m O condicinal do loop deve ser um boolean\n";
...
INICIALIZA_MULTI 	: INICIALIZA
					...
					| INICIALIZA ',' INICIALIZA_MULTI
					{
						...
						if ($1.tipo != $3.tipo) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Um vetor não pode receber tipos diferentes\n";
...
INICIALIZA 	: TK_NUM
			...
			// | TK_COMENTARIO //tentar arrumar e fazer funcionar
			// {
			// 	$$.tipo = "comentario";
			// 	$$.conteudo = $$.label;
			// 	$$.label = gentempcode();
			// 	addStr($$.label, $$.tipo, $$.label, $$.conteudo);
			// 	$$.traducao = "\tcomentario(" + $$.label + ", " + $1.label + ");\t//"+ $$.label +"\n";
			// }
...
DECLARA_VAR : TIPO TK_ID
			{
				...
				if(encontrei)
					error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A variavel '" + $2.label + "' já foi declarada\n";
				
				if ($1.isVector){
					addVector($2.label, $$.tipo, temp, $1.vetor, "0");
				}
					...
					$$.traducao = $2.traducao + $1.traducao + "\t" + temp + " = 0" + ";\n";
					$$.label = temp;
				}
			...
			| TIPO TK_ID '=' INICIALIZA_MULTI 
			{
				...
				if ($1.isVector){
					...
					if (num_elementos_iniciados > $1.sizeVector) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Excesso de elementos para o vetor (" + $2.label + ")\n";
					addVector($2.label, $1.tipo, temp, $1.vetor, $4.conteudo);
					num_elementos_iniciados = 0;
				}
				
				else if ($1.tipo == $4.tipo && $1.tipo == "string"){
					...
					addSimbolo($2.label, $1.tipo, temp);
			
					$$.traducao = $2.traducao + $4.traducao + "\t" + temp + " = " + $4.label + ";\n";
					$$.label = $1.tipo + $2.label + " = " + $4.label;
				}

				else if($1.tipo == "bool"){ 
					if($4.tipo != "bool"){
						error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m valor (" + $4.conteudo + ") inválido para o tipo bool\n";
					}
				...
				else error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Atribuição inválida para a variável (" + $2.label + ")\n";
			}

			| TK_ID TK_DOIS_PTS_IGUAL INICIALIZA_MULTI 
			{
				$$.tipo = $3.tipo;
				bool encontrei = buscaVariavel($2.label); 
				string temp = gentempcode();
				...
				if(encontrei)
					...
					addStr($2.label, "string", temp, $3.conteudo);
					$$.traducao = $3.traducao + "\tstrcpy(" + temp + ", " + $3.label + ");\n"; 
				}
			...
			| TK_ID
			{
				...
				if(encontrei)
					error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A variavel '" + $1.label + "' já foi declarada\n";

				error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A variável '" + $1.label + "' não pode ser inicializada sem um tipo.\n";
			}

			| TK_ID TK_DOIS_PTS_IGUAL 
			{
				bool encontrei = buscaVariavel($1.label);
				...
				error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A variável '" + $1.label + "' não pode ser inicializada sem um valor após ':='.\n";
			}

			| TK_ID '=' INICIALIZA_MULTI
			{
				bool encontrei = buscaVariavel($1.label);
				...
				error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Não foi declarado um tipo para a variável '" + $1.label + "'.\n";
			} 

			| TIPO TK_ID TK_DOIS_PTS_IGUAL INICIALIZA_MULTI
			{
				bool encontrei = buscaVariavel($2.label);
				...
				error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m A variável '" + $2.label + "' Declarada com o operador ':=' não dever ter tipo definido.\n";
			}
			;
...
E 			: E '+' E
			...
			{
				bool encontrei = buscaVariavel($1.label);
				if (!encontrei) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Variável (" + $1.label + "Não declarada.\n";
			...
			| TK_ID '=' E
			{
				...
				if (!encontrei && !busca_fun) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Variável(" + $1.label + "Não declarada.\n";
			...
			| TK_ID '=' INICIALIZA
			{
				bool encontrei = buscaVariavel($1.label);
				if (!encontrei) {
					error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Variável (" + $1.label + ") Não Declarada.\n";
				}
			...
			| TK_SCAN '(' '&' TK_ID ')'
			{
				...
				if (!encontrei) error += "\033[1;31mError\033[0m - \033[1;30mLinha " + linha_atual + ":\033[0m\033[1;39m Variável (" + $4.label + ") Não declarada.\n";
